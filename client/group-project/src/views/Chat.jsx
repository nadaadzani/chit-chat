...
const chat = ({ url, socket }) => {
  ...
  async function fetchChatsHistory() {
    try {
      const { data } = await axios.get(`${url}/chat/${id}`, {
        headers: { Authorization: `Bearer ${localStorage.access_token}` },
      });
  ...
  return (
    <>
      {/* Hello world */}
      {/* component */}
      <div className="flex-1 px-3 py-1 sm:px-6 sm:py-2 justify-between flex flex-col h-screen">
        <div className="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
          <div className="relative flex items-center space-x-4">
            ...
            <div className="flex flex-col leading-tight">
              ...
              <span className="text-lg max-md:hidden text-gray-600">
                {user?.status}
              </span>
            </div>
          </div>
          ...
          {chatsHistory?.map((chat) => {
            return (
              <>
                {chat?.Recipient != id ? (
                  <>
                    <div className="chat-chat" key={chat.id}>
        ...
        <div className="flex items-end">
          <div className="flex flex-col space-y-2 text-md max-w-md mx-2 order-2 items-start">
            ...
            <div>
              <span className="px-4 py-2 rounded-lg inline-block bg-gray-300 text-gray-600">
                I have update the description so its more obviously now
              </span>
            </div>
            <div>
              <span className="px-4 py-2 rounded-lg inline-block bg-gray-300 text-gray-600">
        ...
        <div className="flex items-end justify-end">
          ...
          {/* <div className="chat-message">
        <div className="flex items-end justify-end">
          <div className="flex flex-col space-y-2 text-md max-w-sm mx-2 order-1 items-end">
            <div>
